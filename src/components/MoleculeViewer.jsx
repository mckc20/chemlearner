      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-xl mx-4 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-gray-700">
          <div>
            ...
            <p className="text-sm font-mono text-gray-500 dark:text-gray-400">{molecule.formula}</p>
          </div>
          <button
            onClick={onClose}
        ...
        {isAmbiguous && (
          <div className="px-5 py-2.5 bg-amber-50 dark:bg-amber-900/20 border-b border-amber-200 dark:border-amber-800 text-sm text-amber-800 dark:text-amber-300">
            The formula {molecule.formula} is ambiguous. Displaying the most common structure (Isomer A). Use a SMILES string for specific results.
          </div>
        )}
